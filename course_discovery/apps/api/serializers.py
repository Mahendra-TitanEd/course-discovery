...
class ProgramSerializer(MinimalProgramSerializer):
    ...
    assignment_due = serializers.DateTimeField()
    upgrade_deadline = serializers.DateField()
    ...
    class Meta(MinimalProgramSerializer.Meta):
        ...
        fields = MinimalProgramSerializer.Meta.fields + (
            ...
            'end_date', 'enrollment_start', 'enrollment_end', 'upgrade_deadline', 'assignment_due', 'certificte_overview', 'overview_2', 
            ...
            'videosblock_set', 'video_block_title', 'seo_title', 'effort', 'enrollment_btn_title', 'enrollment_info', 'preview_button_1', 'preview_button_2', 'additional_campaign_info', 
            'content_activation_window', 'advertised_start'  # Added by Yagnesh effort field
        )
