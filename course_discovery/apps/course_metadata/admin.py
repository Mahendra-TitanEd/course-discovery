...
class ProgramAdmin(admin.ModelAdmin):
    ...
    fields = (
        'uuid', 'title', 'subtitle', 'seo_title', 'short_description', 'status', 'type', 'partner', 'partner_display', 'banner_image', 'card_image', 'marketing_slug', 
        ...
        'is_upcoming', 'in_subscription', 'advertised_start', 'enrollment_info', 'preview_button_1', 'preview_button_2', 'access_duration', 'content_activation_window', 'video_block_title',
    )
...
class PersonAdmin(admin.ModelAdmin):
    inlines = (PersonSocialNetworkInline, )
