...
class Program(PkSearchableMixin, TimeStampedModel):
    ...
    certificte_overview = HtmlField(verbose_name="Program Certificate Overview", null=True, blank=False)
    live_class_overview = HtmlField(verbose_name="Demo Live Classes Overview", null=True, blank=False)
    ebooks_overview = HtmlField(verbose_name="E-Books from EBC Reader Overview", null=True, blank=False)
    placement_overview = HtmlField(verbose_name="INTERNSHIP & PLACEMENT PARTNERS Overview", null=True, blank=False)
