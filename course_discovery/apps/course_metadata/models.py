...
class Program(PkSearchableMixin, TimeStampedModel):
    ...
    certificte_overview = NullHtmlField(verbose_name="Program Certificate Overview")
    live_class_overview = NullHtmlField(verbose_name="Demo Live Classes Overview")
    ebooks_overview = NullHtmlField(verbose_name="E-Books from EBC Reader Overview")
    placement_overview = NullHtmlField(verbose_name="INTERNSHIP & PLACEMENT PARTNERS Overview")
