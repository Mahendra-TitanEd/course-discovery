...
class Program(PkSearchableMixin, TimeStampedModel):
    ...
    null=True,
    blank=True,
    help_text='Insert hours and minutes for self-paced programmes.'
    )
    ...
    preview_button_1 = models.TextField(verbose_name="Preview Button 1", null=True, blank=True, help_text="Enter HTML content to be displayed below program title and subtitle on the program about page")
    preview_button_2 = models.TextField(verbose_name="Preview Button 2", null=True, blank=True, help_text="Enter HTML content to be displayed below program title and subtitle on the program about page")
    ...
    content_activation_window = models.CharField(
        verbose_name="Programme Access Duration Text",
        max_length=1024,
        blank=True,
        null=True,
        help_text="Enter the programme access period (e.g., '3-Year Access'). This will be displayed on the program about page after start date, price, instutiton etc information",
    )
